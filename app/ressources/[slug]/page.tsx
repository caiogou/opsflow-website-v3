    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-8 py-14 md:py-20">
        <p className="text-xs font-bold tracking-widest uppercase mb-6">
          <a href="/ressources" className="no-underline text-teal">Ressources</a>
        </p>
        ...
        <section className="mt-14 border-t border-gray-200 pt-8">
          <p className="text-xs font-bold tracking-widest text-teal uppercase mb-4">À lire aussi</p>
          <ul className="space-y-2 list-none pl-0">
            {others.map((o) => (
              <li key={o.slug}>
                <a href={`/ressources/${o.slug}`} className="text-navy hover:text-teal no-underline">{o.h1}</a>
              </li>
            ))}
          </ul>
        </section>
